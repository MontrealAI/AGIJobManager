...
export const CONTRACT_ADDRESS = (process.env.NEXT_PUBLIC_AGI_JOB_MANAGER_ADDRESS || '0xB3AAeb69b630f0299791679c063d68d6687481d1') as `0x${string}`;
export const AGI_TOKEN_ADDRESS = (process.env.NEXT_PUBLIC_AGI_TOKEN_ADDRESS || '0xa61a3b3a130a9c20768eebf97e21515a6046a1fa') as `0x${string}`;
