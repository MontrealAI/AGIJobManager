import { configuredUSDC } from './usdc';
...
export const USDC_TOKEN_ADDRESS = configuredUSDC(Number(process.env.NEXT_PUBLIC_CHAIN_ID || 1), process.env.NEXT_PUBLIC_USDC_TOKEN_ADDRESS) as `0x${string}`;
