...
export default function Admin() {
  ...
  const controls = <Card><h2 className='font-serif'>v0.9.3 owner controls</h2><p>Use the USDC console to update payout wallets, propose an owner or accept ownership. Wallet changes require paused intake and no reserved escrow. A proposed owner can accept directly from the console.</p><p className='mt-2'><a className='underline' href='https://github.com/MontrealAI/AGIJobManager/releases/download/v0.9.3/agijobmanager-usdc.html'>Download the USDC console</a> · <a className='underline' href='https://github.com/MontrealAI/AGIJobManager/blob/v0.9.3/docs/OWNER_CONTROLS.md' target='_blank' rel='noopener noreferrer'>Owner guide</a></p></Card>;
