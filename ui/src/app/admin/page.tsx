...
export default function Admin() {
  ...
  if (!isOwner) return <div className='container py-8'><Card>Not authorized (owner only).</Card>{env.demoMode && <Card>Demo owner preview: type confirmations are required for PAUSE / SETTLEMENT / LOCK.</Card>}</div>;
