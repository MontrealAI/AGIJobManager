...
contract AGIJobManager is Ownable, ReentrancyGuard, Pausable, ERC721 {
    ...
    function _computeAgentBond(uint256 payout, uint256 _duration) internal view returns (uint256 bond) {
    ...
    function _computeReputationPoints(Job storage job) internal view returns (uint256 reputationPoints) {
        ...
        unchecked {
            ...
            uint256 payoutPoints = scaledPayout * scaledPayout * scaledPayout;
