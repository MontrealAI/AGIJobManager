...
By default the Truffle config enables `viaIR` to keep runtime bytecode within the mainnet limit. Keep the setting consistent for verification, and use the Standard JSON path if the Etherscan plugin cannot verify.
