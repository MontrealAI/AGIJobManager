...
**New in v1.4.0:** [qualified admission primitives](OPERATIONS/QUALIFIED_ADMISSION.md) add lifecycle stress cases, signed evidence attestations, operator-owned limits and read-only canonical economic observations. Private runtimes are excluded; admission remains conditional on measured inputs. [Qualification scope](qualification/V140_QUALIFIED_ADMISSION.md).
...
| Edition | Contents |
| --- | --- |
| [v1.4.0](https://github.com/MontrealAI/AGIJobManager/releases/tag/v1.4.0) | Lifecycle stress modeling, signed qualification verification and canonical economic observations; contract, settlement and privacy safeguards retained |
...
## v1.4.0 admission primitives

The public tools cover explicit lifecycle stress cases, operator-owned economic limits, signed evidence attestations, and current canonical two-RPC terms. They do not implement an autonomous signing service or certify market inputs. See [qualified admission](OPERATIONS/QUALIFIED_ADMISSION.md) and [qualification limits](qualification/V140_QUALIFIED_ADMISSION.md).
