...
**Current edition: v1.12.0.** Use [release identity and deployment commands](RELEASE_GUIDE.md), the matching archive and its exact-source evidence. AGIJobManager coordinates USDC-funded jobs, bonded review and buyer recovery; work and evidence evaluation occur outside the contract.
...
**v1.12.0 adds participant project cash planning and stricter held-out cohort loss/supervision limits.** The public evidence gate requires signed commissioning, held-out independent validation, complete actual costs, useful cash settlements, measured intervention time and an external review of the exact source/scope. Private Fleet 1.10.0, Agent 1.16.0 and Node 2.17.0 add a dedicated-account native execution workflow, encrypted handoffs, exact job/delivery grants, signed receipts, durable resumption, application identity pins, revocation, a private project DAG, reservations and a portable commissioning corpus. Public signing/payout behavior and dependency resolutions remain unchanged. These implementation changes do not establish actual Mac operation or independent assurance.
...
| --- | --- |
| [v1.12.0](https://github.com/MontrealAI/AGIJobManager/releases/tag/v1.12.0) | Participant project cash scenarios, cohort loss/supervision gates and private stale-observation rejection |
| [v1.11.0](https://github.com/MontrealAI/AGIJobManager/releases/tag/v1.11.0) | Workforce policy V2, capacity planning and dependent-review time admission |
...
| [v1.6.1](https://github.com/MontrealAI/AGIJobManager/releases/tag/v1.6.1) | Initial release/documentation alignment and generated deployment command map |
...
The public tools cover explicit lifecycle stress cases, operator-owned economic limits, signed evidence attestations, and current canonical two-RPC terms. They do not implement an autonomous signing service or certify market inputs. See [qualified admission](OPERATIONS/QUALIFIED_ADMISSION.md) and [current pre-funding and closure scope](OPERATIONS/PREFUNDING.md).
