...
| --- | --- |
| [v1.6.1](https://github.com/MontrealAI/AGIJobManager/releases/tag/v1.9.0) | Documentation/release alignment, current command map, corrected download routes and automated drift checks |
