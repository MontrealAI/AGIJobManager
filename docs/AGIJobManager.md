# AGIJobManager Contract Documentation — v1.0.2
...
| `ValidatorBondParamsUpdated` | `setValidatorBondParams` | Since v0.9.6, emits updated defaults; an existing job retains its first-vote collateral amount. |
