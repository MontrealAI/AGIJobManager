...
> v0.9.5 uses immutable six-decimal USDC and requires a fresh deployment. Read the [USDC migration guide](https://github.com/MontrealAI/AGIJobManager/blob/v0.9.5/docs/USDC_MIGRATION.md) before following operational examples. Historical receipts are not USDC deployments.
...
> These guides preserve historical references; their old deployment commands are retired. Use the Hardhat guide above for v0.9.5 and later.
