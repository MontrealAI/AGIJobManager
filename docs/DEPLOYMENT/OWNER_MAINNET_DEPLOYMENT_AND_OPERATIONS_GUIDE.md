...
- Success check: `AGITypeUpdated` event, then read `agiTypes(index)` for the relevant index (from prior AGITypeUpdated history) to confirm address and payout percentage.
