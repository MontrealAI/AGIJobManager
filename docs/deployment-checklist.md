...
1. Compile with `SOLC_VERSION=0.8.33`, `SOLC_RUNS=200`, `SOLC_VIA_IR=false`.
...
1. Compile with `SOLC_VIA_IR=true` and the same optimizer/metadata settings when verifying a viaIR deployment.
