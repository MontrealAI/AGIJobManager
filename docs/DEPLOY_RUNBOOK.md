# Deployment and operations — v0.9.7
...
- The contract is non-upgradeable. A verified v0.9.6 manager remains compatible with the v0.9.7 console; first deployments and moves from incompatible older versions require a fresh manager.
