# Deployment and operations — v1.0.2
...
- The contract is non-upgradeable. A verified v0.9.6 manager remains compatible with the v1.0.2 console; first deployments and moves from incompatible older versions require a fresh manager.
