...
- The escrow token is fixed at deployment to the canonical AGI token (`0xA61a…`).
- There is no on-chain token rotation; redeploy if the token address ever needs to change.
