...
| `SOLC_VERSION` / `SOLC_RUNS` / `SOLC_VIA_IR` / `SOLC_EVM_VERSION` | Compiler settings | Defaults: `SOLC_VERSION=0.8.19`, `SOLC_RUNS=50`, `SOLC_VIA_IR=true`, `SOLC_EVM_VERSION=london`. |
