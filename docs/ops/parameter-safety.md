...
| --- | --- | --- | --- | --- | --- |
| `agiToken` (immutable) | ERC‑20 address | Escrow deposits, payouts, marketplace purchases, reward pool, `withdrawAGI`. | Fixed to `0xA61a3B3a130a9c20768EEBF97E21515A6046a1fA` (standard ERC‑20). | Not configurable post‑deploy; invalid address is rejected at deploy time. | Not applicable (constructor enforces invariant). |
