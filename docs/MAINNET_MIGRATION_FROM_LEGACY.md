...
This page preserves the provenance of the earlier snapshot-based migration for the recorded legacy address `0x0178B6baD606aaF908f72135B8eC32Fc1D5bA477`. Its Truffle deployment and signing procedure is retired and must not be used for v0.9.2.
