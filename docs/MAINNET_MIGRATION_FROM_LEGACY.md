...
- If snapshot `challengePeriodAfterApproval` is `0`, migration aborts by default to prevent silent policy drift (opt-in override: `ALLOW_CHALLENGE_PERIOD_DEFAULT_ON_ZERO=1`).
