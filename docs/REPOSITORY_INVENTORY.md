...
> v0.9.1: Contract tests use Hardhat 3 and Mocha; Truffle and Ganache have been removed. Use [Hardhat](https://github.com/MontrealAI/AGIJobManager/blob/v0.9.1/hardhat/README.md) for public deployments and the [owner console](https://github.com/MontrealAI/AGIJobManager/blob/v0.9.1/docs/OWNER_CONTROLS.md) for live configuration.
