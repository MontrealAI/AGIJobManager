...
1. Open the versioned [USDC console](https://github.com/MontrealAI/AGIJobManager/releases/download/v1.7.0/agijobmanager-usdc.html), select the verified compatible manager and connect the accepted owner wallet. Confirm the chain and contract address.
