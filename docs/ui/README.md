...
Current USDC entry: [v0.9.5 standalone console](https://github.com/MontrealAI/AGIJobManager/releases/download/v0.9.5/agijobmanager-usdc.html), with the [matching repository artifact](../../ui/agijobmanager-usdc.html). Verify checksums and configure a verified new manager; no live manager is supplied by default.
