# USDC standalone console v0.9.1

Open [the console](../../ui/agijobmanager-usdc.html). Configure the address of a newly deployed, source-verified v0.9.1 USDC manager on Ethereum mainnet. No manager is configured by default.
...
All amounts use USDC with at most six decimal places. Excess precision is rejected. Approval, escrow, bonds, settlement and withdrawals use the same USDC address. The old bridge/vault panel is retired, and saved forms and wallet context use a new v0.9.1 namespace.
