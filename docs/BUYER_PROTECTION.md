...
v0.9.6 requires a fresh manager and eight fixed linked libraries. Existing jobs, token allowances and ENS pages remain on their original contracts. Publishing this software does not activate it on Ethereum.
