# Source verification on Etherscan — v0.9.3
...
The previous detailed page is retained in the [v0.8.0 source](https://github.com/MontrealAI/AGIJobManager/blob/v0.8.0/docs/VERIFY_ON_ETHERSCAN.md) as historical material; its retired deployment instructions are not a current execution path.
