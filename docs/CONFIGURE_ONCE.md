...
1. Parameter updates (validation reward is ordered against AGI type and additional-agent payout updates based on payout headroom)
2. AGI type updates (if not already applied before validation reward)
