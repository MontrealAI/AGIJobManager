# Mainnet deployment and verification — v0.9.3
...
Truffle and Ganache have been removed. Local tests use Hardhat 3, and historical deployment migrations are retired. Do not use an old receipt or the legacy contract address as a v0.9.3 deployment.
...
The previous detailed page is retained in the [v0.8.0 source](https://github.com/MontrealAI/AGIJobManager/blob/v0.8.0/docs/mainnet-deployment-and-verification.md) as historical material; its retired deployment instructions are not a current execution path.
