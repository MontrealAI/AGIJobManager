# Mainnet deployment and verification — v0.9.4
...
Truffle and Ganache have been removed. Local tests use Hardhat 3, and historical deployment migrations are retired. Do not use an old receipt or the legacy contract address as a v0.9.4 deployment.
