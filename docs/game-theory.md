...
**Example:** a 1,000 USDC successful job at the default validator rate pays an 80 USDC validator budget, 300 USDC to wallet one, 100 USDC to wallet two, and 520 USDC to the agent. Bond slashing and rounding follow the [v0.9.1 rules](USDC_PAYOUT_SPLIT.md).
