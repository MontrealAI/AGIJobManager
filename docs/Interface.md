...
| `getJobCore(uint256 jobId)` | view | uint256, address, uint256, uint256, address, uint256, bool, bool, bool, bool, uint8, bool |
| `getJobValidation(uint256 jobId)` | view | uint256, uint256, uint256, uint256 |
| `getJobMetadata(uint256 jobId)` | view | string, string, string, string |
