...
3. Inspect source commit `c77647a513966eb47bae55bba53303a59b0a9d84` (tree `e6577d65448ea14100196af07103096b722ee38c`) and the per-file inventory in `RELEASE_MANIFEST.json`.
