...
- **Evidence gates:** 11 static-review parser/gate tests cover a valid fixture and 33 rejection scenarios; 16 publication-gate tests exercise source/workflow/job/tree mismatch, incomplete qualification, exact checkout association and missing/duplicated/incorrect/unavailable log evidence. Compiler-patch tests reject unreviewed bytes and check exact output and idempotence.
