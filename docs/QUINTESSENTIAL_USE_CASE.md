# Quintessential Use Case — current USDC software
...
1. **Release and scope:** verify the selected [source, checksums and matching qualification evidence](V1_RELEASE_SCOPE.md#published-download-versus-current-source). Publishing software does not deploy a live manager or verify an operator's production setup.
