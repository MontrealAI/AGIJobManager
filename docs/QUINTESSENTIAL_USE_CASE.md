# Quintessential Use Case — v1.0.2
...
1. **Release and scope:** verify v1.0.2 source/checksums and its qualification evidence. Publishing software does not deploy a live manager or verify an operator's production setup.
