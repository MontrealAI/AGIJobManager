...
contract. It is a business‑operated system, not a DAO.

## 1) Trust model (owner‑operated system)

AGIJobManager is an owner‑operated system. Users must trust the owner and
