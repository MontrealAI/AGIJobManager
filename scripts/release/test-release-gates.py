...
class ReleaseGateTests(unittest.TestCase):
    def setUp(self):
        ...
        self.meta = self.root / 'docs/releases/v1.0.2'
        self.meta.mkdir(parents=True)
        self.config = {
            'repository': REPOSITORY, 'tag': 'v1.0.2', 'sourceCommit': SOURCE,
            'sourceTree': TREE,
            'requiredSourceRuns': {
...
class ReleaseUploadTests(unittest.TestCase):
    def setUp(self):
        ...
        self.release = {'id': 123, 'tag_name': 'v1.0.2', 'target_commitish': SOURCE,
                        'draft': True, 'assets': [],
        ...
        self.clock = Mock()
        namespace = {'repo': REPOSITORY, 'tag': 'v1.0.2', 'source': SOURCE,
