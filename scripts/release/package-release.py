"""Create a deterministic, checksum-verified archive of the pinned v1.0.3 source."""
import argparse
import hashlib
import io
import json
...
parser.add_argument('--out', type=pathlib.Path, default=root / 'build/release/v1.0.3')
