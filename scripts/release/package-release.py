"""Create a deterministic, checksum-verified archive of the pinned v0.9.6 source."""
import argparse
import hashlib
import io
import json
...
parser.add_argument('--out', type=pathlib.Path, default=root / 'build/release/v0.9.6')
