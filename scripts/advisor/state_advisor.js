...
function main() {
  ...
  if (state === 'IN_PROGRESS' && expireAt !== null && now > expireAt) {
    console.log('- Note: requestJobCompletion is suppressed because now is past assignedAt + duration for a non-disputed job.');
  }
