...
const nodeConstraint = rootPkg.engines?.node ?? uiPkg.engines?.node ?? 'n/a (not pinned in manifest)';
const npmConstraint = rootPkg.engines?.npm ?? uiPkg.engines?.npm ?? 'n/a (not pinned in manifest)';
