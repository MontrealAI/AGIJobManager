...
**{{TAG}} adds operational workforce qualification and a native runtime descriptor.** The public evidence gate requires signed commissioning, held-out independent validation, complete actual costs, useful cash settlements, measured intervention time and an external review of the exact source/scope. Private Fleet {{FLEET}}, Agent {{AGENT}} and Node {{NODE}} add a dedicated-account native execution workflow, encrypted handoffs, exact job/delivery grants, durable recovery, reservations and a portable commissioning corpus. Public signing/payout behavior and dependency resolutions remain unchanged. These implementation changes do not establish actual Mac operation or independent assurance.
...
| --- | --- |
| [{{TAG}}](https://github.com/MontrealAI/AGIJobManager/releases/tag/{{TAG}}) | Operational qualification, native runtime identity and separately delivered private native-workforce tools |
