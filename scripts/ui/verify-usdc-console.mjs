...
// Exercise the current development console without wallet access or transactions.
// scripts/release/verify-usdc-ui.mjs remains the verifier for frozen v1.0.0.
