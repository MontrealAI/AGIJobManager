...
**Development branch notice:** source after the v0.9.5 tag includes an unreleased read-only bond getter and a console that requires it for voting. Check out the exact qualified release/commit you intend to deploy; do not treat this branch as the published v0.9.5 bytecode. [Follow-up compatibility notes](../docs/qualification/BUYER_ECONOMICS_FOLLOWUP.md).
