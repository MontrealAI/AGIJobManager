...
- `solc-input.json`: Full Solidity Standard JSON Input artifact (includes `sources` + `settings`) for deterministic bytecode reproduction and manual Etherscan Standard JSON verification.
