...
**New in v1.7.0:** [Pre-funding qualification](docs/OPERATIONS/PREFUNDING.md) checks employer and participant economics, exact funding intent, measured-value references and separate capital/cost/capacity limits before escrow. Canonical cancellation proofs support reservation reconciliation. The public console remains manual; these off-chain primitives require an integrating runner. [Qualification scope](docs/qualification/V160_PREFUNDING.md).
